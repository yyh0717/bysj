(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var ProfTitleComponent = /** @class */ (function () {
                ...
                ProfTitleComponent.prototype.ngDoCheck = function () {
                    if (this.currentPag !== this.oldCurrentPag || this.pagNums !== this.oldPagNums) {
                        ...
                        var startNum = curren * pagNum;
                        for (var i = 0; i < pagNum; i++, startNum++) {
                            if (this.profTitles[startNum] !== null && this.profTitles[startNum] !== undefined) {
                                this.dataShow.push(this.profTitles[startNum]);
                            }
                        }
                        this.oldCurrentPag = this.currentPag;
                        this.oldPagNums = this.pagNums;
                ...
                ProfTitleComponent.prototype.getprofTitles = function () {
                    ...
                    this.profTitleService.getProfTitles()
                        .subscribe(function (res) { _this.profTitles = res; _this.leng = res.length; });
                };
            ...
            var AddTeacherComponent = /** @class */ (function () {
                ...
                AddTeacherComponent.prototype.getColleges = function () {
                    ...
                    this.teacherService.getColleges()
                        .subscribe(function (res) { return _this.schools = res; }); // 将返回到的参数赋值给schools
                };
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\mso\Documents\Tencent Files\739414374\FileRecv\myapp（加登录翻页总）\myapp\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
